...
class CodeWriter():
	...
	def writeMemoryAccess(self, command, segment, variable):
		...
		###if(segment == "static"):
			asmCode = "\n//this is a static segment translation\n"
			variable = (int)variable + 16

			if(command == "pop"):
				asmCode += "decrease pointer, retrive pointer value and push to RAM[variable]"
			elif(command == "push"):	
				asmCode += "retrieve RAM[variable] and push to pointer, increase pointer"		
